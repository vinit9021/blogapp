...
app.get('/homepage', authenticateToken, async (req, res) => {
  ...
  try {
    ...
    const perPage = 9; // how many posts per page
...
app.get('/createpost', authenticateToken, (req, res) => {
...
app.get('/posts/:id/edit', authenticateToken, async (req, res) => {
  try {
...
app.get('/posts/:postId/comment', authenticateToken, async (req, res) => {
...
app.get('/posts/:id1/comments/:id2', authenticateToken, async (req, res) => {
    try{
...
// update a comment
app.put('/posts/:id1/comments/:id2', authenticateToken, async (req, res) => {
    try{
        const postID = req.params.id1;
        const commentID = req.params.id2;
...
// delete a comment
app.delete('/posts/:id1/comments/:id2', authenticateToken, async (req, res) => {
    const postID = req.params.id1;
    const commentID = req.params.id2;
    try{
